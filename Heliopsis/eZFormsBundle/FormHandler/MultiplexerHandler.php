<?php
/**
 * MultiplexerHandler Class
 *
 * Allows to use multiple handlers one after the other
 *
...
class MultiplexerHandler implements LocationAwareHandlerInterface, ContentAwareHandlerInterface
{
